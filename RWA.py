...
SYMBOL_MAP = {
    'ARB': 'ARB1-USD', 'SUI': 'SUI-USD', 'PEPE': 'PEPE1-USD',
    'SOL': 'SOL-USD', 'FET': 'FET-USD', 'SEI': 'SEI-USD'
}
...
def render_master_v18_1(data, is_rwa):
    for d in data:
...
with t1: render_master_v18_1(tab1_data, True)
with t2: render_master_v18_1(tab2_data, False)
