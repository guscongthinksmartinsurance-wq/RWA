...
# LỖI FIX TẠI ĐÂY: Ép kiểu float cho total_realized
total_realized = float(df_holdings['Profit_Realized'].sum()) if not df_holdings.empty else 0.0
...
def render_v10_fix(data, is_rwa):
    for d in data:
